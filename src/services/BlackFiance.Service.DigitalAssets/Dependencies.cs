using BlackFiance.Service.DigitalAssets.Data;
using BlackFiance.Service.DigitalAssets.Features.DigitalAssets;
...
namespace BlackFiance.Service.DigitalAssets
{
    public static class Dependencies
    {
        public static void Configure(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddMediatR(typeof(GetDigitalAssets));

            services.AddTransient<IDigitalAssetsDbContext, DigitalAssetsDbContext>();
            ...
            services.AddDbContext<DigitalAssetsDbContext>(options =>
            {
                options.UseSqlServer(configuration["Data:DefaultConnection:ConnectionString"],
                    builder => builder.MigrationsAssembly("BlackFiance.Service.DigitalAssets")
                        .EnableRetryOnFailure())
                .UseLoggerFactory(DigitalAssetsDbContext.ConsoleLoggerFactory)
